...
Измеримое — score, состав документов в выдаче, факт отказа — подставляется
автоматически; содержательные оценки проставляются по результатам разбора.
"""
